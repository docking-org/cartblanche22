...
tmux send-keys -t 2 "conda activate cartblanche22 && cd $PROJECT_DIR/backend && gunicorn -b :5001 -w 3 --log-level=DEBUG --access-logfile - --error-logfile - application --timeout 36000 --reload" C-m
