...
swc_server = 'https://swc.docking.org'; // nm debug deployment
...
function newSearch(smiles) {
    ...
    if (!!window.EventSource) {
        ...
        source = new EventSource(swc_server + '/search/submit?smi=' + encodeURIComponent(search_state.smi) +
...
function export_results() {
    ...
    window.open(swc_server + '/search/export?' + $.param(params));
}
