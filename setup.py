...
setup(
    ...
    url='https://github.com/zula1010/molecule-shopping-cart',

    # Author details
    author='Munkhzul Khurelbaatar',
    author_email='munkhzulk@gmail.com',
